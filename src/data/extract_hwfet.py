...
SOURCE_FILE = PROJECT_ROOT / "data" / "raw" / "HWFET_raw.txt"
OUTPUT_FILE = PROJECT_ROOT / "data" / "raw" / "HWFET_raw.csv"
...
# Standard HWFET has no road-grade information
